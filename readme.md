...
* **Setup:** Two Ubuntu VMs (US and EU) each running a Node.js application and a Tailscale Subnet Router.
...
Secrets Needed:
- Tailscale Auth Key re-usable, authenticate Tailscale node
